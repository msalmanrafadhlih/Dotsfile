...

{
  programs.bash = {
        ...
        initExtra = ''
# plugins
source ~/.config/bash/plugins/colored-man-pages/colored-man-pages.plugin.sh
source ~/.config/bash/plugins/fzf/fzf.plugin.sh
source ~/.config/bash/plugins/progress/progress.plugin.sh
