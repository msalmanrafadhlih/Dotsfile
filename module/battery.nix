...
let
  batteryScript = pkgs.writeScript "battery-notify.sh" ''
    ...
    ICON_LOW="~/.repos/nixos/user/tquilla/config/bspwm/src/assets/LowBat.png";
    ICON_FULL="~/.repos/nixos/user/tquilla/config/bspwm/src/assets/FullBat.png";
    SOUND_LOW="~/.repos/nixos/user/tquilla/config/dunst/sound/emotional-damage-meme.wav";
    SOUND_FULL= "~/.repos/nixos/user/tquilla/config/dunst/sound/hidup-jokowi.wav";
    ...
    if [[ "$STATUS" == "Discharging" && "$CAPACITY" -le 20 ]]; then
      ...
      canberra-gtk-play -f "~/.repos/nixos/user/tquilla/config/dunst/sound/emotional-damage-meme.wav" -V 8.0
      ...
      canberra-gtk-play -f "~/.repos/nixos/user/tquilla/config/dunst/sound/hidup-jokowi.wav" -V 8.0
    fi
  '';
in
{
